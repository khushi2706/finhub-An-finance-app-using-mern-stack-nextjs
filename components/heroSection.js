            ...
            <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                <div className="mr-auto place-self-center lg:col-span-7">
                    ...
                    <div className="flex flex-wrap gap-4">
                        ...
                        {/* Sign In Button */}
                        <Link
                            href="/signin"  // Navigate to the signin page
                            className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-gray-900 border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800"
                        >
                            Sign In
                        </Link>
                        {/* Sign Up Button */}
                        <Link
                            href="/signup"  // Navigate to the signup page
                            className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-white rounded-lg bg-secondary-600 hover:bg-secondary-700 focus:ring-4 focus:ring-secondary-300 dark:focus:ring-secondary-900"
                        >
                            Sign Up
                        </Link>
                    </div>
